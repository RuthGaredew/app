  ...
  return (
    <footer className="footer--container">
      <div className="footer--link--container">
        ...
        <div className="footer--social--icon">
          <ul>
            <li>
              <a
                href="https://www.facebook.com/people/Rutina-Garedew/pfbid0AiJieHsTJsLZ1miWEjaTc9anH4nA6yQS5s8FwYMBQ6QPAqF4dmBqpMV32HExD9sHl/?ref=xav_ig_profile_web"
            ...
            <li>
              <a
                href="https://x.com/RGaredew97999"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <li>
              <a
                href="https://www.linkedin.com/in/ruth-garedew/"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
      ...
      <div className="footer--content--container">
        <p className="footer--content">Made with 💖 by Ruth</p>
        <div className="footer--social--icon">
          <ul>
            <li>
              <Link
